...
require_once __DIR__ . '/../../src/api/PDO/inmuebles/modelojson.php'; // Incluye el archivo con la clase modelojson

class DeleteTestInmuebles extends TestCase
{
    private $pdo;
    private $datos;
...
// Ejecuta esta prueba con: ./vendor/bin/phpunit --bootstrap vendor/autoload.php test/inmuebles/DeleteTestInmuebles.php --colors
