    ...
    class pruebasSolas extends TestCase
    {
        ...
        {
            $tabla = 'personas';
            $id_persona = 2; // Reemplaza con un ID válido de tu base de datos para la prueba
    ...
    // Ejecuta esta prueba con: ./vendor/bin/phpunit --bootstrap vendor/autoload.php test/pruebasSplas.php --colors
